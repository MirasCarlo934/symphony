...
public class GetHTTPReq extends HTTPRequest {
	 ...
	 */
	public GetHTTPReq(/*String id, HTTPEngine engine, */String url, HashMap<String, String> headers, HashMap<String, String> parameters, 
			int[] validResponseCodes) {
		super(/*id, engine, */url, HTTPRequestType.GET, true, headers, parameters, validResponseCodes);
	}
}
