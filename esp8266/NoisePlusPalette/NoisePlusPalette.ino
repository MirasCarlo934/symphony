...
// water.
uint16_t speed = 50; // speed is set dynamically once we've started up
...
//  LEDS.addLeds<LED_TYPE,LED_PIN,COLOR_ORDER>(leds,NUM_LEDS);
  ...
  y = random16();
  z = random16();
  Serial.println("************END NoisePlusPalette Setup***************");
}
...
//      leds[XY(i,j)] = color;
      for( int ii = 0; ii < NUM_PIXELS; ii++) {
		for(int jj=0; jj<LED_STRINGS;jj++) {
			theLeds[jj][ii] = color;
		}
	  }
    }
...
void ChangePaletteAndSettingsPeriodically()
{
  ...
  if( lastSecond != secondHand) {
    ...
    if( secondHand ==  0)  { currentPalette = RainbowColors_p;         speed = 2; scale = 30; colorLoop = 1; }
    if( secondHand ==  5)  { SetupRedBlueAndGreenPalette();             speed = 1; scale = 50; colorLoop = 1; }
    if( secondHand == 10)  { SetupGreenAndRedStripedPalette();       speed = 2; scale = 30; colorLoop = 1; }
    if( secondHand == 15)  { currentPalette = ForestColors_p;          speed =  8; scale =120; colorLoop = 0; }
    if( secondHand == 20)  { currentPalette = CloudColors_p;           speed =  4; scale = 30; colorLoop = 0; }
    if( secondHand == 25)  { currentPalette = LavaColors_p;            speed =  8; scale = 50; colorLoop = 0; }
    if( secondHand == 30)  { currentPalette = OceanColors_p;           speed = 2; scale = 90; colorLoop = 0; }
    if( secondHand == 35)  { currentPalette = PartyColors_p;           speed = 2; scale = 30; colorLoop = 1; }
    if( secondHand == 40)  { SetupRandomPalette();                     speed = 2; scale = 20; colorLoop = 1; }
    if( secondHand == 45)  { SetupRandomPalette();                     speed = 5; scale = 50; colorLoop = 1; }
    if( secondHand == 50)  { SetupRandomPalette();                     speed = 9; scale = 90; colorLoop = 1; }
    if( secondHand == 55)  { currentPalette = RainbowStripeColors_p;   speed = 3; scale = 20; colorLoop = 1; }
  }
}
